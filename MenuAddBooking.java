...
public class MenuAddBooking extends Menu
{
    String chaletName;
    String bookedBy;
    java.util.Date dt;
    ...
    protected void waitForInput()
    {
        ...
        System.out.println("Type the booker's name here: ");
        bookedBy = kybd.next();
    ...
    {
        //Command DP: Client
        ChaletBooking newBooking = new ChaletBooking(chaletName, bookedBy, startDate, endDate, null, null, false, null, false);
        Command addBookingMenuCmd = new AddBookingMenuCommand(newBooking);
        MenuRunner myMenuRunner = new MenuRunner();
        myMenuRunner.runMenuOrAction(addBookingMenuCmd);
    }
}
